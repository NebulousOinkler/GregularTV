...
/// and the guide, so it reads the same everywhere. The words are shared
/// (`BreakText`); this is how Apple TV draws them.
enum BreakStyle {
    static let title = BreakText.title
    static let symbol = BreakText.symbol
